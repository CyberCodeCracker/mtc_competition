      ...
      <div class="login-container">
        ...
        <div class="login-branding">
          <div class="branding-content">
            <img src="assets/logo.png" alt="ENET'COM Forum" class="brand-logo animate-float" />
            <h1 class="brand-title">ENET'COM Forum</h1>
        ...
        <div class="login-form-container">
          <div class="login-form-wrapper glass-card">
            ...
            <form [formGroup]="loginForm" (ngSubmit)="onSubmit()">
              ...
              >
                <app-loading-spinner *ngIf="isLoading" [message]="''"></app-loading-spinner>
