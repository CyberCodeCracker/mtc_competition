...
@Component({
        ...
        <div class="offer-card glass-card" *ngFor="let offer of filteredOffers()" [@fadeIn]>
          ...
          <div class="offer-footer">
            ...
            <div class="action-buttons">
              <button class="btn-icon btn-glass" title="Edit" (click)="editOffer(offer)">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                  <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path>
                  <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path>
                </svg>
              </button>
              <button class="btn-icon btn-glass" title="View Applications" [routerLink]="['/company/offers', offer.id]">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                  <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
                  <circle cx="12" cy="12" r="3"></circle>
                </svg>
              </button>
              <button class="btn-icon btn-danger-glass" title="Delete" (click)="confirmDelete(offer)">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
  ...
  styles: [`
    ...
    .btn-danger-glass:hover { background: rgba(239,68,68,0.2); }
...
export class CompanyOffersComponent implements OnInit {
  ...
  editOffer(offer: Offer): void {
    // Navigate to edit form - for now just log
