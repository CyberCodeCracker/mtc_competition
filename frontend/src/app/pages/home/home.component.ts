...
@Component({
          ...
          <div class="hero-visual">
            <div class="shield-container">
              ...
              <svg class="connection-lines" viewBox="0 0 400 400">
                <circle cx="200" cy="200" r="150" fill="none" stroke="rgba(0, 212, 170, 0.2)" stroke-width="1" stroke-dasharray="5 5" />
                <circle cx="200" cy="200" r="180" fill="none" stroke="rgba(33, 150, 243, 0.15)" stroke-width="1" stroke-dasharray="8 8" />
              </svg>
            </div>
          </div>
        </div>
  ...
  styles: [`
    ...
    .shield {
      ...
      width: 200px;
      height: 230px;
      background: linear-gradient(135deg, rgba(0, 188, 212, 0.3), rgba(0, 212, 170, 0.3));
