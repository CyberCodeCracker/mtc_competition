...
@Component({
      ...
      <nav class="home-nav glass">
        <div class="nav-container">
          <a routerLink="/" class="nav-logo">
            <img src="assets/enet.png" alt="ENET'COM" class="logo-img-full" />
          </a>
          ...
          <ul class="nav-links">
            ...
            <li><a [routerLink]="getDashboardRoute()" class="nav-link">Dashboard</a></li>
          </ul>

          <div class="nav-actions">
            <a *ngIf="!isAuthenticated()" routerLink="/login" class="btn-glass">Sign In</a>
            <span *ngIf="isAuthenticated()" class="user-greeting">Hello, {{ getUserName() }}</span>
          </div>
        </div>
      </nav>
        ...
        <div class="hero-container">
          <div class="hero-content">
            ...
            <div class="hero-actions">
              <a routerLink="/login" class="btn-primary" style="display: flex; align-items: center; gap: 8px;">
                Get Started
          ...
          <div class="hero-visual">
            <div class="shield-container">
              <!-- Shield with Logo -->
              <div class="shield">
                <img src="assets/enet.png" alt="ENET'COM" style="width: 100%; height: auto;" class="shield-logo" />
              </div>
      ...
      <section id="gallery" class="gallery-section">
        <div class="section-container">
          <div class="section-header">
            ...
            <h2 class="section-title">Previous Forum Editions</h2>
            <p class="section-description">
              Relive the moments from our past forums featuring top companies and talented students.
            </p>
          </div>
          ...
          <div class="gallery-wrapper">
            <div class="gallery-slider">
              <div class="gallery-track" [style.transform]="'translateX(-' + currentSlide * 100 + '%)'">
                <div class="gallery-slide" *ngFor="let image of galleryImages; let i = index">
            ...
            <div class="gallery-controls">
              <button class="gallery-arrow gallery-prev" (click)="prevSlide()" [disabled]="currentSlide === 0">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              ...
              <button class="gallery-arrow gallery-next" (click)="nextSlide()" [disabled]="currentSlide === galleryImages.length - 1">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
      ...
      <footer class="home-footer">
        <div class="footer-container">
          <div class="footer-brand">
            <img src="assets/enet.png" alt="ENET'COM" class="footer-logo-full" />
          </div>
          <p class="footer-copyright">
            © 2026 ENET'COM. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
  ...
  styles: [`
    ...
    .user-greeting {
      ...
      background: linear-gradient(135deg, rgba(246, 139, 30, 0.15), rgba(0, 61, 124, 0.15));
...
export class HomeComponent implements OnInit, OnDestroy {
  ...
  galleryImages = [
    {
      url: 'assets/gallery/forum1.jpg',
      alt: 'ENET\'COM Forum Edition 1'
    },
    {
      url: 'assets/gallery/forum2.jpg',
      alt: 'ENET\'COM Forum Edition 2'
    },
    {
      url: 'assets/gallery/forum3.jpg',
      alt: 'ENET\'COM Forum Edition 3'
    },
    {
      url: 'assets/gallery/forum4.jpg',
      alt: 'ENET\'COM Forum Edition 4'
    },
    {
      url: 'assets/gallery/forum5.jpg',
      alt: 'ENET\'COM Forum Edition 5'
    }
  ];
